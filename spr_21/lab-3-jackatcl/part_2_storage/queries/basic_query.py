...
def main(spark, file_path):
    ...
    print('Times to run Basic Query 5 times on {file_path}')
    print(times)
    print('Maximum Time taken to run Basic Query 5 times on {file_path}:{max(times)}')

    # You can do list calculations for your analysis here!
    print('Basic query mean={:4f}'.format(sum(times) / len(times)))
